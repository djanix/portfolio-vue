...
<script>
  import desktopImagePath from '~/static/images/moher_cliffs.jpg';
  import mobileImagePath from '~/static/images/moher_cliffs_mobile.jpg';
...
<style scoped lang="scss">
  .hero {
    ...
    background: url('/images/moher_cliffs_blur.jpg') top center / cover no-repeat;
    color: #effcd9;
    ...
    @media screen and (orientation:portrait) {
      background-image: url('/images/moher_cliffs_mobile_blur.jpg');
    }
  }
